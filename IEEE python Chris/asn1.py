...
"""
HeaderInfo:                 ToBeSignedData:     SignerInfo:         SignedData:         EncryptedData:      Ieee1609Dot2Data:
- PSID                      - payload           - signer            - hashID            - recipients        - content
- generationTime            - headerInfo        - signature         - tbsData           - cipherText        - contentType
- generationLocation        - extDataHash       - extDataHash       - signerInfo        - icv               - protocolVersion
- p2pcdLearningRequest                                                                  - symmAlgorithm
- missingCrlIdentifier      RecipientInfo:
- inlineP2pcdRequest        - recipientID
- ...
"""
